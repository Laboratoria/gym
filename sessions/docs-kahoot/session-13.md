...
2. Llamada a la función: Cuando llamas a la función, pasas valores concretos para estos parámetros. Por ejemplo:
...
#### Switch case
En JavaScript, la declaración switch se utiliza para realizar diferentes acciones basadas en diferentes condiciones
```js
switch (expr) {
  case "Naranjas":
