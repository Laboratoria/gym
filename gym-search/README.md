...
The blog posts are stored in `/_posts` as Markdown files with front
matter support. Adding a new Markdown file in there will create a new blog post.
...
Preview the example live on [StackBlitz](http://stackblitz.com/) or [Codeanywhere.com](http://codeanywhere.com)
