...
Um modelo HTML e CSS é fornecido para você fornecer
a funcionalidade para criar um jogo de caça-minas.
Ajudando você com ferramentas como: ChatGPT; você deve trabalhar no código
adicionando os elementos interativos necessários, o modelo fornece
Um exemplo de como devem ser as células descobertas.

__Caracteristicas:__

- Clicar no botão central deve reiniciar o jogo.
- A placa consiste em 64 células, 8x8
- 10 minas é recomendado
- Os segundos do jogo devem ser contabilizados no cabeçalho

[Regras do CampoMinado](https://www.minesweeper.info/wiki/Windows_Minesweeper#:~:text=You%20can%20mark%20a%20mine,you%20click%20on%20a%20mine.)
